...
describe("UpdatePhoto", () => {
    ...
    it("should return a photo updated when updatePhotoRepository insert it", async () => {
        const photo = await testInstance(fakeQuery, fakePhotoEntity);
        expect(photo).toEqual(fakePhotoEntity);
    });
    it("should return null a new photo updated when updatePhotoRepository return it", async () => {
